...
convertedExpression = parse_expr(matematicalOperationString)
otro = sympy.srepr(convertedExpression)

print(convertedExpression)

#src = Source(sympy.dotprint(parse_expr(matematicalOperationString)))
a, b, c, d = sympy.symbols('6, 2, 3, 4')
expr = (a+b/-c)+b-d

src = Source(sympy.dotprint(expr), format='png')
src.render('output.png', view=True)
